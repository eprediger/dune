...
TankView::TankView(Tank& tank, SdlWindow& window) :
    ...
    if (sprites.empty()) {
        sprites.emplace(std::make_pair(Orientation::indefinida(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000ba250.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::norte(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000b748d.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::noroeste(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000b7bae.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::oeste(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000b8ae8.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::sudoeste(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000b996e.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::sur(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000ba250.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::sudeste(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000baa5f.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::este(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000bba76.bmp", window))));
        sprites.emplace(std::make_pair(Orientation::noreste(), std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/000bc58e.bmp", window))));

        std::vector<std::unique_ptr<SdlTexture> > norte;
        norte.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-n1.bmp", window)));
        norte.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-n2.bmp", window)));
        attack_sprites.emplace(std::make_pair(Orientation::norte(),
                                              std::move(norte)));

        std::vector<std::unique_ptr<SdlTexture> > noroeste;
        noroeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-nw1.bmp", window)));
        noroeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-nw2.bmp", window)));
        noroeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-nw3.bmp", window)));
        attack_sprites.emplace(std::make_pair(Orientation::noroeste(),
                                              std::move(noroeste)));

        std::vector<std::unique_ptr<SdlTexture> > oeste;
        oeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-w1.bmp", window)));
        oeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-w2.bmp", window)));
        attack_sprites.emplace(std::make_pair(Orientation::oeste(),
                                              std::move(oeste)));

        std::vector<std::unique_ptr<SdlTexture> > sudoeste;
        sudoeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-sw1.bmp", window)));
        sudoeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-sw2.bmp", window)));
        attack_sprites.emplace(std::make_pair(Orientation::sudoeste(),
                                              std::move(sudoeste)));

        std::vector<std::unique_ptr<SdlTexture> > sur;
        sur.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-s1.bmp", window)));
        sur.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-s2.bmp", window)));
        attack_sprites.emplace(std::make_pair(Orientation::sur(),
                                              std::move(sur)));

        std::vector<std::unique_ptr<SdlTexture> > sudeste;
        sudeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-se1.bmp", window)));
        sudeste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-se2.bmp", window)));
        attack_sprites.emplace(std::make_pair(Orientation::sudeste(),
                                              std::move(sudeste)));

        std::vector<std::unique_ptr<SdlTexture> > este;
        este.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-e1.bmp", window)));
        este.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-e2.bmp", window)));
        attack_sprites.emplace(std::make_pair(Orientation::este(),
                                              std::move(este)));

        std::vector<std::unique_ptr<SdlTexture> > noreste;
        noreste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-ne1.bmp", window)));
        noreste.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/tank-ne2.bmp", window)));
