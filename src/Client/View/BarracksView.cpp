    ...
    :BuildingView(barracks,window,Area(0,0,72,68),Area(0,0,72,68))
{
    if (sprites.empty()){
        ...
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/001512c3.bmp",window)));
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/00152601.bmp",window)));
        sprites.emplace(std::make_pair("Atreides",std::move(vector)));
        vector.clear();
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/0019be4d.bmp",window)));
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/0019cf5f.bmp",window)));
        sprites.emplace(std::make_pair("Harkonnen",std::move(vector)));
        vector.clear();
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/001e6511.bmp",window)));
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/001e7669.bmp",window)));
