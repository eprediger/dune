...
WindTrapView::WindTrapView(WindTrap& windtrap, SdlWindow& window) :
    ...
    if (sprites.empty()) {
        ...
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/0014efd8.bmp",window)));
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/001500d6.bmp",window)));
        sprites.emplace(std::make_pair("Atreides", std::move(vector)));
        vector.clear();
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/001998e7.bmp",window)));
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/0019a9f0.bmp",window)));
        sprites.emplace(std::make_pair("Harkonnen", std::move(vector)));
        vector.clear();
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/001e41eb.bmp",window)));
        vector.emplace_back(std::unique_ptr<SdlTexture>(new SdlTexture("../imgs/imgs/001e52f4.bmp",window)));
